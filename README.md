...
Если вы хотите внести свой вклад в существующий проект, к которому у вас нет принудительного доступа, вы можете «разветвить» проект. Когда вы «форкнете» проект, GitHub создаст копию проекта, которая будет полностью вашей; он живет в вашем пространстве имен, и вы можете нажать на него.
Таким образом, проектам не придется беспокоиться о добавлении пользователей в качестве соавторов, чтобы предоставить им push-доступ. Люди могут разветвить проект, отправить его и внести свои изменения обратно в исходный репозиторий, создав так называемый запрос на включение, о котором мы поговорим далее. Это открывает ветку обсуждения с проверкой кода, и владелец и участник могут затем сообщать об изменении до тех пор, пока владелец не будет доволен им, после чего владелец может объединить его.

Чтобы создать форк проекта, посетите страницу проекта и нажмите кнопку «Разветвить» в правом верхнем углу страницы.

![Кнопка fork](14.png)

Через несколько секунд вы перейдете на страницу нового проекта с собственной записываемой копией кода.

## Порядок действий на GitHub

GitHub спроектирован вокруг особого рабочего процесса совместной работы, основанного на запросах на извлечение. Этот процесс работает независимо от того, сотрудничаете ли вы со сплоченной командой в одном общем репозитории, с глобально распределенной компанией или сетью незнакомцев, вносящих свой вклад в проект через десятки форков. В его основе лежит рабочий процесс тематических ветвей. 

Вот как это обычно работает:
* Форкните проект.
* Создайте ветку темы из master.
* Внесите некоторые изменения для улучшения проекта.
* Отправьте эту ветку в свой проект GitHub.
* Откройте запрос на включение на GitHub.
* Обсудите и, при необходимости, продолжайте принимать решения.
* Владелец проекта объединяет или закрывает запрос на включение.
* Синхронизируйте обновленное master обратно с вашей вилкой.
