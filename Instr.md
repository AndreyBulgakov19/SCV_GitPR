...
1. Нажать на кнопку *Pull requests* на сайте GitHub из скопированного репозитория.
2. Нажать на *New pull request*.
3. Сменить ветку на новую в фильтрах.
4. Нажать *Create pull request*.
5. Добавили описание коммита.

***Готово!***  
Pull Request появится в оригинальном репозитории в разделе Pull Requests.