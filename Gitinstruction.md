...
Делаем clone своей версии репозитория на локальном компьютере. Создаем новую ветку и в нее вносим свои изменения, фиксируем их коммитами.
Отправляем свою версию в свой GitHub. На сайте GitHub  нажимаем конпку pull request и отправляем наши предложения управляющему удаленным репозиторием.
