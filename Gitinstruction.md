...
После чего отправляем наш файл пользователю, которому хотим предложить изменения командой
...
## Важно!
Если мы созадли ветку, которой нет в оригинальном файле и не сделали **merge** то Git предложит нам команду:
