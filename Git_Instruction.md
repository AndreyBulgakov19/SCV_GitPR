...
## 5. Добавление изменений из локального репозитория в удалённый.
...
Далее также клонируем копию репозитория на локальный компьютер и вносим необходимые изменения.
