...
## 4. Внесение изменений в репозиторий.
...
## 6. Просмотр фиксаций и отслеживание изменений в коммитах.
...
## 7. Возвращение файла к предыдущему состоянию.
...
## 8. Возврат к актуальному состоянию.
