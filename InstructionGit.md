...
![Скрин консоли](image\scrconslog.PNG)
...
![Скрин файла .gitignore](image\scrgi.PNG)
...
![Сркрин консоли с выбором дейсвтия](image\confl.PNG)
...
![Скрин консоли, ошибка удаления ветки](image\NotMerge.PNG)
...
1. Для создания нового удалённого репозитория на [GitHub](https://github.com/) нажать кнопку ![Create a new repository](image\GitHubImage2.PNG) на [домашней странице](https://github.com/dashboard), либо нажать в вверхнем правом углу на ***+*** - "Create new.." и выбрать ***New repository***:
...
![Страница создания репозитория](image\CrRep.PNG)
