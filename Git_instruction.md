...
После внесения изменений нужно направить автору репозитория их на рассмотрение. Для этого нужно подать заявку на слияняие веток и выполнить команду *Pull request*.
