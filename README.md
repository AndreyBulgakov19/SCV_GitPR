...
>Пример: 
> <span style="color:purple"> git remote add origin </span> "ссылка на репозиторий в гитхабе"
> <span style="color:purple"> git branch -M </span> main
> <span style="color:purple"> git push -u origin </span> main
...
При помощи команды __FORK__ выполяемой на удалённом репозитории - копируется и соединяется в наследующую цепь в ваш репозиторий на __github__. После выполнения "форка", можно сделать локальную привязку на ваш локальный ПК при помощи команды __git clone "ссылка на репозиторий"__

После клонирования документа на локальный репозиторий с ним можно произвести любые изменения.

После внесения изменений нам нужно выгрузить репозиторий обратно при помощи команды __push__. 

После записи всех изменений командой "git push" в своем удалённом репозитории, используя функцию __"Pull request"__ на __github__, мы предлагаем внести изменения в удалённый репозиторий.
