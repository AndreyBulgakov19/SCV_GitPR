...
Важно понимать что при использовании **push** или **pull**, будут мерджится ветки и если что-то одновременно изменялось в локальном и удаленном репозитории, то тоже будет возникать конфликт, который вам нужно будет решить. Выглядит это воооот так: