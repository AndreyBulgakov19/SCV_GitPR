...
Клонировать существующий удаленный репозиторий можно с использованием команды `git clone <ссылка на удаленный репозиторий>`. Обязательно создать новую ветку командой `git switch -c (название ветки)` затем в данной ветке создать файл и уже в него вносить свои изменения/дополнения.
